...
namespace Orienteering.ViewModels
{
    ...
    public class ContestViewModel : ViewModelBase
    {
        ...
        private RouteRepository routeModel;
        private ContestRepository contestModel;
        ...
        private ContestViewModel()
        {
            ...
            userModel = new UserRepository(DBHelper.ConnectionString);
            routeModel = new RouteRepository(DBHelper.ConnectionString);
            contestModel = new ContestRepository(DBHelper.ConnectionString);
            ...
            StartStopContest = new RelayCommand(() =>
            {
                if (!ContestInProgress)
                {
                        ...
                        && contest.IsOpen)
                    {
                        ...
                        contestModel.AddControlPointsToContest(contest, routeModel.GetRouteControlPoints(SelectedRoute));
